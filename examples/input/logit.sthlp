...
{p 8 15 2}
{opt logi:t} {depvar} [{indepvars}] {ifin}
...
{p 4 6 2}{cmd:bootstrap}, {cmd:by}, {opt fp}, {cmd:jackknife}, {opt mfp},
...
{phang}
{bf:Statistics > Binary outcomes > Logistic regression, reporting coefficients}
