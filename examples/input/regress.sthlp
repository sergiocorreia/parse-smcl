...
{pstd}
{cmd:regress} fits a model of {depvar} on {indepvars} using linear regression.

{pstd}
See {help estimation commands} for a list of other regression commands that
may be of interest.
